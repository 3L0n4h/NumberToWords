Public Class frm
  Dim firstNum, secondNum, result As Double
    ...
    Private Sub btnPlus_Click(sender As Object, e As EventArgs) Handles btnPlus.Click
        labelResult.Text = AmountInWords(txtAmount.Text.Trim)
    ...
    Public Function AmountInWords(ByVal nAmount As String, Optional ByVal wAmount _
        ...
        Try
            ...
            Else
                ...
                If (Math.Round(Val(nAmount), 2) * 100) > 0 Then

                    ' Multiply by 100 and round to 2 decimal places
                    Dim cents As Double = Math.Round(nAmount * 100)

                    ' Format cents as a string with leading zeros
                    Dim centsFormatted As String = cents.ToString("00")

                    ' Construct the final cents part in the desired format
                    Dim centsText As String = centsFormatted & " Fils"

                    wAmount = wAmount & "Dirham And " & centsText
                End If
            End If
        ...
        If IsNothing(wAmount) = True Then wAmount = String.Empty Else wAmount =
          IIf(InStr(wAmount.Trim.ToLower, "dirham"),
